...
const HeroSection = () => {
  return (
    <div>
      <section id="home" className="w-full px-6 md:px-12 pb-8 pt-10 md:pt-20 mt-10 md:mt-0 animate-fade-in">
        <div className="flex flex-col space-y-2">
          ...
          <div className="md:mt-4">
            <h1
              className="text-3xl md:text-5xl font-semibold leading-tight max-w-3xl md:max-w-full animate-fade-up"
